...
Please update both Persian and English README sections when changing user-facing behavior. Never commit real shared keys, server addresses, generated configurations, or logs containing private data.
